      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_text1 text-center mx-auto">आईटी परामर्श के लिए अपने निःशुल्क 30 मिनट के स्केलिंग ग्रोथ मैप का अनुरोध करें</h1>
            </div>
          </div>

          <div class="row justify-content-center align-items-center">
            <div class="col-md-7 mt-5">
              <p class="ck_gs_text2">क्या आप अपने व्यवसाय को अगले स्तर पर ले जाने के लिए तैयार हैं? आईटेक्नेबुला में, हम आपके जैसे व्यवसायों को विशेषज्ञ आईटी समाधानों के माध्यम से स्केलेबल विकास हासिल करने में मदद करने में विशेषज्ञ हैं। व्यावसायिक सफलता की दिशा में आपकी यात्रा शुरू करने के लिए, हम मुफ़्त 30-मिनट स्केलिंग ग्रोथ मैप कॉल मूल्य (5,000) की पेशकश कर रहे हैं।</p>
            </div>
          </div>

          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_2.php"><button class="ck_gs_btn"> शुरू हो जाओ <img src="Assets/Images/gs_right_arrow.png" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-5 col-md-6 mb-4 mb-md-0 ft-rjj">
                ...
                <h5 class="text-rjj">अपनी डिजिटल यात्रा को सशक्त बनाना
                  ...
                  <span class = "ck_textsec8_122" style = " फ़ॉन्ट-वेट: बोल्ड;">इटेक्नेबुला</span> भविष्य को नेविगेट करना
                  विश्वास के साथ
                </h5>
