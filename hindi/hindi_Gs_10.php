      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_10_text1">क्या आप उन मौजूदा चुनौतियों या मुद्दों का वर्णन कर सकते हैं जिनका आप अपने मौजूदा आईटी बुनियादी ढांचे के साथ सामना कर रहे हैं?
          ...
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-7 mt-5">
                ...
                <button class="ck_gs_10_btn mt-5"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </div>
            </div>
          </form>
