      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-8">
              <h1 class="ck_gs_12_text1">क्या आपके मन में इस परियोजना के लिए कोई बजट है?
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-7">
              <div class="range-container mt-5">
                ...
                <button class="ck_gs_12_btn mt-5"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
