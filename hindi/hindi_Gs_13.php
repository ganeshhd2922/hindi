      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_13_text1">क्या समय या कार्मिक जैसी कोई संसाधन संबंधी बाधाएँ हैं, जिनके बारे में हमें अवगत होना चाहिए?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_14.php"><button class="ck_gs_13_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
