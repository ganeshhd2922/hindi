      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_14_text1">आपको इस समाधान को पूरी तरह से लागू करने की आवश्यकता कब है?</h1>
            </div>
          </div>
          ...
          <div class="row">
            <div class=" ">
              <a href="Gs_15.php"><button class="ck_gs_14_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
