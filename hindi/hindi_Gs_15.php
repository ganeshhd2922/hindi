      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_15_text1">क्या कोई महत्वपूर्ण मील का पत्थर या समय सीमा है जिसके बारे में हमें अवगत होना चाहिए?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_16.php"><button class="ck_gs_15_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
