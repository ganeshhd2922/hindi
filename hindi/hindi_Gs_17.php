      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_17_text1">संभावित आईटी विक्रेताओं का मूल्यांकन करने के लिए किन मानदंडों का उपयोग किया जाएगा?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_18.php"><button class="ck_gs_17_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <section class="">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 col-md-6 mb-4 mb-md-0 ft2-rjj">
                <h5 class="text-w">इटेक्नेबुला</h5>
