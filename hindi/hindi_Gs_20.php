      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_20_text1">क्या आप अगले कुछ वर्षों में अपने संगठन में किसी बदलाव या विस्तार की आशा करते हैं?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_21.php"><button class="ck_gs_20_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
