      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_21_text1">क्या स्केलेबिलिटी इस परियोजना के लिए एक विचार है?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="Gs_22.php"><button class="ck_gs_21_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-5 col-md-6 mb-4 mb-md-0 ft-rjj">
                ...
                <h5 class="text-rjj">अपनी डिजिटल यात्रा को सशक्त बनाना
                    ...
                    <span class = "ck_textsec8_122" style = " फ़ॉन्ट-वेट: बोल्ड;">इटेकनेब्यूला</span> भविष्य को नेविगेट करना
                    विश्वास के साथ
                </h5>
