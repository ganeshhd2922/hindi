      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_22_text1">आपका वर्तमान मासिक राजस्व क्या है?
          ...
          <div class="row">
            <div class="mt-5 ">
              <a href="thankyou.html"><button class="ck_gs_22_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button></a>
            </div>
          </div>
        </div>
      </div>
