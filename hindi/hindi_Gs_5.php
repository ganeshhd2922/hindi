        ...
        <div class="col-lg-10">
          <form method="post" action="" enctype="multipart/form-data">
            <div class="row justify-content-center align-items-center">
              <div class="col-md-8">
                <h1 class="ck_gs_5_text1">आपका व्यवसाय किस शहर में स्थित है?</h1>
              </div>
            </div>
            ...
            <div class="row">
              <div class="mt-5 ">
                <button type="submit" class="ck_gs_5_btn"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </div>
            </div>
          </form>
        </div>
