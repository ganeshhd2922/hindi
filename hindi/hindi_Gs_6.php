      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_6_text1">आपको क्या लगता है कि यह आईटी समाधान आपके संगठन के लिए आवश्यक क्यों है?
              </h1>
            </div>
          </div>
          <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-md-7 mt-5">
                ...
                <button type="submit" class="ck_gs_6_btn mt-5"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
              </div>
            </div>
