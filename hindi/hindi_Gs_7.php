      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          <div class="row justify-content-center align-items-center">
            <div class="col-md-8">
              <h1 class="ck_gs_7_text1">इस समाधान में आपके संगठन के लिए कौन सी विशिष्ट कार्यक्षमताएँ या सुविधाएँ आवश्यक हैं?
              </h1>
            </div>
          </div>
          ...
          <div class="row justify-content-center align-items-center">
            ...
            <input type="text" placeholder="MESSAGE" name="message" class="ck_gs_7_input1 mx-2 text-center" />
             <button class="ck_gs_7_btn mt-5"> जारी रखना <img src="Assets/Images/gs_right_arrow.png" class="img-fluid" style="width: 75px; height: 25px;"> </button>
